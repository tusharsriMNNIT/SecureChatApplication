...
//        fileois = new ObjectInputStream(fileSendSocket.getInputStream());
        ...
        System.out.println("\nStart generating RSA key");
         ...
         try {
                ...
                DecRSAandSign decryptRSAwithSignature = new DecRSAandSign(aeSkeyAndSignature.getCipherKeyAES(), clientPrivateKey, serverPublicKey, aeSkeyAndSignature.getSignature(),"AES");
                ...
                //MessageDecryptionRSA decryptedAESkey = new MessageDecryptionRSA(aeSkeyAndSignature.getCipherKeyAES(), keyRSAPrivate);
                DecRSAandSign decryptRSAwithSignature1 = new DecRSAandSign(deSkeyAndSignature.getCipherKeyDES(), clientPrivateKey, serverPublicKey, deSkeyAndSignature.getSignature(),"DES");
        ...
        new UI(readSocket,writeSocket,AESKey,DESKey,ois,oos,fileSendSocket,"client").setVisible(true);
